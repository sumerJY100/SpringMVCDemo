...
@Entity
@Table(name = "device_point_history13", schema = "wind", catalog = "")
public class DevicePointHistory13Pojo {
    public static String TABLE_NAME = "device_point_history4";
    ...
    public DevicePointHistory13Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory13Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory13Pojo that = (DevicePointHistory13Pojo) o;
