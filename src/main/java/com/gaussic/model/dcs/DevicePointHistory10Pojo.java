...
@Entity
@Table(name = "device_point_history12", schema = "wind", catalog = "")
public class DevicePointHistory10Pojo {
    public static String TABLE_NAME = "device_point_history1";
    ...
    public DevicePointHistory10Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory10Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory10Pojo that = (DevicePointHistory10Pojo) o;
