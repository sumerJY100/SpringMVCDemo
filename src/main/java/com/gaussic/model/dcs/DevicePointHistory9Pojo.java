...
@Entity
@Table(name = "device_point_history9", schema = "wind", catalog = "")
public class DevicePointHistory9Pojo {
    ...
    public DevicePointHistory9Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory9Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory9Pojo that = (DevicePointHistory9Pojo) o;
