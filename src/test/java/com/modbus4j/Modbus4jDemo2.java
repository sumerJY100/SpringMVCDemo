...
//
//            BaseLocator<Number> locator = BaseLocator.holdingRegister(slaveId, 100, DataType.EIGHT_BYTE_INT_UNSIGNED);
//            master.setValue(locator, 130);
//            System.out.println(master.getValue(locator));
//        }
//        finally {
//            master.destroy();
