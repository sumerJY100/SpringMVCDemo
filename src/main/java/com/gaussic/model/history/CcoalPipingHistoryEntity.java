...
@Entity
@Table(name = "ccoal_piping_history", schema = "wind", catalog = "")
public class CcoalPipingHistoryEntity implements  CoalPipingHistory{
    private long id;
    ...
    public CcoalPipingHistoryEntity(CoalMillEntity coalMillEntity, Date now) {
        this.hTime = new Timestamp(now.getTime());
        this.hCoalMillId = coalMillEntity.getId();
    }
    public  CcoalPipingHistoryEntity(   ){
    ...
    public boolean equals(Object o) {
        ...
        CcoalPipingHistoryEntity that = (CcoalPipingHistoryEntity) o;
        return id == that.id &&
