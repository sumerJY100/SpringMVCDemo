...
public class DevicePointHistory8Pojo {
    ...
    public DevicePointHistory8Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory8Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory8Pojo that = (DevicePointHistory8Pojo) o;
