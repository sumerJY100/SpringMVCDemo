...
@Entity
@Table(name = "device_point_history3", schema = "wind", catalog = "")
public class DevicePointHistory3Pojo {
    ...
    public DevicePointHistory3Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory3Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory3Pojo that = (DevicePointHistory3Pojo) o;
