...
@Entity
@Table(name = "device_point_history6", schema = "wind", catalog = "")
public class DevicePointHistory6Pojo {
    ...
    public DevicePointHistory6Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory6Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory6Pojo that = (DevicePointHistory6Pojo) o;
