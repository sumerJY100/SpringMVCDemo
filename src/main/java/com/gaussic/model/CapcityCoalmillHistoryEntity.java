...
@Entity
@Table(name = "capcity_coalmill_history", schema = "wind", catalog = "")
public class CapcityCoalmillHistoryEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        CapcityCoalmillHistoryEntity that = (CapcityCoalmillHistoryEntity) o;
        return id == that.id &&
