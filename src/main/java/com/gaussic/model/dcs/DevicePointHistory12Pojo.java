...
@Entity
@Table(name = "device_point_history8", schema = "wind", catalog = "")
public class DevicePointHistory12Pojo {
    public static String TABLE_NAME = "device_point_history3";
    ...
    public DevicePointHistory12Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory12Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory12Pojo that = (DevicePointHistory12Pojo) o;
