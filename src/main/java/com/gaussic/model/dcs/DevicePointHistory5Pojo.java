...
@Entity
@Table(name = "device_point_history5", schema = "wind", catalog = "")
public class DevicePointHistory5Pojo {
    ...
    public DevicePointHistory5Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory5Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory5Pojo that = (DevicePointHistory5Pojo) o;
