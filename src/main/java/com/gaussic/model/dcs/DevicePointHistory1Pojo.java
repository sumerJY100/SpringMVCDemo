...
@Entity
@Table(name = "device_point_history1", schema = "wind", catalog = "")
public class DevicePointHistory1Pojo {
    ...
    public DevicePointHistory1Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory1Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory1Pojo that = (DevicePointHistory1Pojo) o;
