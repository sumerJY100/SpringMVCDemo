...
@Entity
@Table(name = "device_point_history4", schema = "wind", catalog = "")
public class DevicePointHistory4Pojo {
    ...
    public DevicePointHistory4Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory4Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory4Pojo that = (DevicePointHistory4Pojo) o;
