$(function () {
    ...
    $("#tb_departments").bootstrapTable("hideColumn","pipeId");
    $("#tb_departments").bootstrapTable("hideColumn","dcsId");
    $("#tb_departments").bootstrapTable("hideColumn","slaveId");
    //2.初始化Button的点击事件
            ...
            // },
             {
                ...
                generatorColumn('dcsName', 'DCS设备', false),
                generatorColumn('pipeId', '管道', false),
                generatorColumn('pipeName', '管道', false),
