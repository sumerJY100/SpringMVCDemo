...
@Entity
@Table(name = "device_point_history14", schema = "wind", catalog = "")
public class DevicePointHistory14Pojo {
    ...
    public DevicePointHistory14Pojo(LocalDateTime localDateTime){
        this.hTime = Timestamp.valueOf(localDateTime);
    }
    public DevicePointHistory14Pojo(){
    ...
    public boolean equals(Object o) {
        ...
        DevicePointHistory14Pojo that = (DevicePointHistory14Pojo) o;
